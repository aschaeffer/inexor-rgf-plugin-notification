...
use crate::behaviour::entity::entity_behaviour_provider::NotificationEntityBehaviourProviderImpl;
...
use crate::provider::NotificationEntityTypeProviderImpl;
...
#[async_trait]
pub trait NotificationPlugin: Plugin + Send + Sync {}

#[module]
pub struct NotificationPluginImpl {
    entity_type_provider: Wrc<NotificationEntityTypeProviderImpl>,
    entity_behaviour_provider: Wrc<NotificationEntityBehaviourProviderImpl>,

    context: PluginContextContainer,
}

impl NotificationPluginImpl {}

interfaces!(NotificationPluginImpl: dyn Plugin);

#[async_trait]
#[provides]
impl NotificationPlugin for NotificationPluginImpl {}

impl Plugin for NotificationPluginImpl {
